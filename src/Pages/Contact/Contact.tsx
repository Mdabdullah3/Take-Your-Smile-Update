...
const Contact = () => {
    ...
    return (
        <div className='contactUs font-mono'>
                    ...
                    <form className='p-0 flex-row' ref={form} onSubmit={handleSubmit(onSubmit)}>
                        <div className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" placeholder="Enter Full Name" className="input input-bordered input-primary" {...register("name", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <input type="email" placeholder="Enter Email" className="input input-bordered input-primary" {...register("email", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <input type="date" className="input input-bordered input-primary" {...register("date", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" placeholder="Enter Phone" className="input input-bordered input-primary" {...register("phone", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <select className="select select-primary w-full" {...register("event", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <textarea className="textarea textarea-primary h-32" placeholder="Please explain details..." {...register("message", {
                                    required: {
                                        value: true,
