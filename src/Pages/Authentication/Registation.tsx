...
const Registation = () => {
  ...
  return (
    <form className="sign-up-form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <input type="submit" className="bg-primary px-6 my-3 text-white cursor-pointer hover:bg-blue-600 transition duration-300 py-3 rounded-full" value="Sign up" />
      <p className="social-text text-secondary mb-6">Or Sign up with social platforms</p>
    </form>
